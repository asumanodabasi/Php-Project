...
<body>
    ...
    <div class="search">
       ...
       <select class="select" aria-label="Default select example">
        <option value="users.php" class="user">Users</option>
        <option   selected value="employee.php" class="employee">Employee</option>
        <option value="ibbveriler.php" class="veri">Ocak Ayı Veri Seti</option>
      </select>
      <script>
